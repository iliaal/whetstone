...
def _register_builtins() -> None:
    ...
    This is the vendored, trimmed SkillOpt: the upstream benchmark environments
    (alfworld, searchqa, docvqa, ...) were dropped. The only registered env is
    the whetstone process-skill optimizer. See VENDORED.md for the source commit.
    """
    try:
        from skillopt.envs.whetstone.adapter import WhetstoneAdapter
        _ENV_REGISTRY["whetstone"] = WhetstoneAdapter
    except ImportError:
        pass  # whetstone env not yet present — skip
