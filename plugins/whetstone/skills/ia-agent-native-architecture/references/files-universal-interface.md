...
Agents are naturally good at files. Claude Code works because bash + filesystem is the most proven agent interface. When building agent-native apps, lean into this.
