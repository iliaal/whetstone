...
ROOT CAUSE: Evidenced causal conclusion with file:line covering every symptom, or remaining uncertainty
...
RELATED:    Same-shape sweep (N checked, N same-shape, fixed/listed, or not run and why); prior bugs, risks, architecture
