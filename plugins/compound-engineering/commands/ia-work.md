...
2. **Consider Reviewer Agents** (Optional)
   ...
   Use for complex, risky, or large changes. Read agents from `compound-engineering.local.md` frontmatter (`review_agents`). If no settings file, run `/ia-setup` to create one.
