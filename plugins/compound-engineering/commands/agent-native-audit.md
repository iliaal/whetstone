...
Full principle definitions and test criteria live in the `agent-native-architecture` skill and its `references/core-principles.md`. This command audits eight principles in parallel:
...
1. Load the `agent-native-architecture` skill and read the specific section for this principle in references/core-principles.md (if it exists) or the Architecture Review Checklist subsection matching this principle's domain.
